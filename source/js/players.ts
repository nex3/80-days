...
export const players: Player[] = [
  ...
  Player.emoji('Coraphii', {
    // UTC-5, Day 33, used 3 graces, two days behind
    emoji: '🐻‍❄️',
    color: rgb('00dda4'),
    progress: 0.4,
    path: [
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 36, used one grace
    emoji: '🌻',
    color: rgb('8773d3'),
    progress: 0.85,
    path: [
