...
export const players: Player[] = [
  ...
  Player.emoji('Coraphii', {
    // UTC-5, Day 55, used 3 graces, three days behind
    emoji: '🐻‍❄️',
    color: rgb('00dda4'),
    progress: 0.75,
    path: [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 57, one grace used
    emoji: '🌼',
    color: rgb('FFD139'),
    path: [
      'London',
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 58, used one grace
    emoji: '🌻',
    color: rgb('8773d3'),
    progress: 0.16,
    path: [
  ...
  Player.emoji('BibliovoreOrc', {
    // Rob, UTC-5, Day 58, one grace used
    emoji: '📚',
    color: rgb('33FF33'),
    progress: 0.2,
    path: [
