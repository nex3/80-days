...
export const players: Player[] = [
  ...
  Player.emoji('@topghost', {
    // Casey, UTC-7, Day 18, down one grace
    emoji: '🙈',
    color: rgb('966bb6'),
    path: [
      'London',
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 18, used one grace
    emoji: '🌻',
    color: rgb('8773d3'),
    progress: 0.9,
    path: [
  ...
  Player.emoji('Modulusshift', {
    // Eli UTC-6, Day 15, used 3 graces, 1 day behind
    emoji: '~',
    color: rgb('96f9f9'),
    path: [
      'London',
  ...
  Player.emoji('Rain Doggerel', {
    // UTC-7, Day 16, used 2 grace (fast forward to Day 16)
    emoji: '☣️',
    color: rgb('14bccc'),
    path: [
      'London',
  ...
  Player.emoji('WulfOrc', {
    // Cliff, UTC-7, Day 17, one grace used
    emoji: '🦀',
    color: rgb('e23b59'),
    progress: 0.05,
    path: [
