...
export const players: Player[] = [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 22
    emoji: '🌼',
    color: rgb('FFD139'), progress: 0.45,
    path: [
      'London',
      'Paris',
      'Amsterdam',
  ...
  Player.emoji('Rain Doggerel', {
    // UTC-7, Day 22, used 2 grace
    emoji: '☣️',
    color: rgb('14bccc'), progress: 0.33,
    path: [
      'London',
      'Paris',
      'Amsterdam',
