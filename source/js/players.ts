...
export const players: Player[] = [
  ...
  Player.emoji('@topghost', {
    // Casey, UTC-7, Day 2, down one grace
    emoji: '🙈',
    color: rgb('966bb6'),
    progress: 0.25,
    path: [
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 24, used two graces
    emoji: '🌻',
    color: rgb('8773d3'),
    progress: 0.2,
    path: [
