...
export const players: Player[] = [
  ...
  Player.emoji('Coraphii', {
    // UTC-5, Day 63, used 3 graces, four days behind
    emoji: '🐻‍❄️',
    color: rgb('00dda4'),
    progress: 0.1,
    path: [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 72, one grace used
    emoji: '🌼',
    color: rgb('FFD139'),
    path: [
      'London',
