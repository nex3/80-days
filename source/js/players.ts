...
export const players: Player[] = [
  ...
  Player.emoji('@topghost', {
    // Casey, UTC-7, Day 10, down one grace
    emoji: '🙈',
    color: rgb('966bb6'),
    path: [
      'London',
  ...
  Player.emoji('Michelle S', {
    ...
    emoji: '🍩️',
    color: rgb('A51DE5'),
    path: ['London', 'Paris', 'Munich', 'Berlin', 'Prague', 'Cairo'],
  }),
  Player.emoji('ferns', {
    // UTC-7, Day 8
    emoji: '🦊️',
  ...
  Player.emoji('Zandra', {
    ...
    emoji: '🐭',
    color: rgb('33ccff'),
    path: ['London', 'Paris', 'Nice', 'Rome', 'Bucharest', 'Odessa'],
  }),
];
