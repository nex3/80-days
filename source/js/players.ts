...
export const players: Player[] = [
  ...
  Player.emoji('Coraphii', {
    // UTC-5, Day 35, used 3 graces, two days behind
    emoji: '🐻‍❄️',
    color: rgb('00dda4'),
    progress: 0.9,
    path: [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 37, one grace used
    emoji: '🌼',
    color: rgb('FFD139'),
    progress: 0.5,
    path: [
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 38, used one grace
    emoji: '🌻',
    color: rgb('8773d3'), progress: 0.4,
    path: [
      'London',
      'Paris',
      'Munich',
  ...
  Player.emoji('Brian P', {
    // UTC-4, Day 38
    emoji: ':/',
    color: rgb('7C8383'), progress: 0.95,
    path: [
      'London',
      'Paris',
      'Amsterdam',
