...
export const players: Player[] = [
  Player.emoji('Lade Ada Locke & Jeanne Watson', {
    // kouhai, UTC-7, Day 9, used 3 grace and down 1 day
    emoji: '✨',
    color: rgb('00002e'),
  ...
  Player.emoji('Coraphii', {
    // UTC-5, Day 10, used 2 graces
    emoji: '🐻‍❄️',
    color: rgb('00dda4'),
    path: ['London', 'Paris', 'Amsterdam', 'Copenhagen', 'Helsinki', 'Minsk'],
  }),
  ...
  Player.emoji('@topghost', {
    // Casey, UTC-7, Day 11, down one grace
    emoji: '🙈',
    color: rgb('966bb6'),
    path: [
      'London',
  ...
  Player.emoji('Michelle S', {
    ...
    emoji: '🍩️',
    color: rgb('A51DE5'),
    path: ['London', 'Paris', 'Munich', 'Berlin', 'Prague', 'Cairo', 'Luxor'],
  }),
  Player.emoji('ferns', {
    // UTC-7, Day 8
    emoji: '🦊️',
  ...
  Player.emoji('BibliovoreOrc', {
    ...
    color: rgb('33FF33'),
    progress: 0.8,
    path: ['London', 'Paris', 'Nice', 'Rome', 'Athens', 'Antalya', 'Beirut'],
  }),
  ...
  Player.emoji('wayward', {
    // UTC-7, Day 11, 1 grace used
    emoji: '🎻',
    color: rgb('9a86a3'),
    progress: 0.65,
    path: ['London', 'Paris', 'Munich', 'Vienna', 'Venice', 'Athens', 'Izmir', 'Antalya'],
  }),
  ...
  Player.emoji('Zandra', {
    ...
    emoji: '🐭',
    color: rgb('33ccff'),
    path: ['London', 'Paris', 'Nice', 'Rome', 'Bucharest', 'Odessa', 'Istanbul'],
  }),
];
