...
export const players: Player[] = [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 42, one grace used
    emoji: '🌼',
    color: rgb('FFD139'),
    progress: 0.6,
    path: [
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 42, used one grace
    emoji: '🌻',
    color: rgb('8773d3'),
    progress: 0.4,
    path: [
