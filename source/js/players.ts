...
export const players: Player[] = [
  ...
  Player.emoji('Modulusshift', {
    // Eli UTC-6, Day 17, used 3 graces, 1 day behind
    emoji: '~',
    color: rgb('96f9f9'),
    path: [
      'London',
  ...
  Player.emoji('WulfOrc', {
    // Cliff, UTC-7, Day 18, one grace used
    emoji: '🦀',
    color: rgb('e23b59'),
    path: [
      'London',
