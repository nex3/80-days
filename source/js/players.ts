...
export const players: Player[] = [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 31, one grace used
    emoji: '🌼',
    color: rgb('FFD139'),
    progress: 0.1,
    path: [
  ...
  Player.emoji('@topghost', {
    // Casey, UTC-7, Day 32, down one grace
    emoji: '🙈',
    color: rgb('966bb6'),
    progress: 0.8,
    path: [
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 31, used one grace
    emoji: '🌻',
    color: rgb('8773d3'),
    progress: 0.35,
    path: [
