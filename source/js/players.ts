...
export const players: Player[] = [
  ...
  Player.emoji('Coraphii', {
    // UTC-5, Day 56, used 3 graces, four days behind
    emoji: '🐻‍❄️',
    color: rgb('00dda4'),
    progress: 0.9,
    path: [
  ...
  Player.emoji('HeartbreakDaisy', {
    // K V, UTC-7, Day 60, one grace used
    emoji: '🌼',
    color: rgb('FFD139'),
    progress: 0.75,
    path: [
  ...
  Player.emoji('Ari-topper', {
    // Delphine, UTC+2, Day 60, used two grace
    emoji: '🌻',
    color: rgb('8773d3'), progress: 0.2,
    path: [
      'London',
      'Paris',
      'Munich',
  ...
  Player.emoji('Michelle S', {
    // UTC-7, Day 53, used 3 grace, three days behind
    emoji: '🍩️',
    color: rgb('A51DE5'),
    progress: 0.2,
    path: [
  ...
  Player.emoji('BibliovoreOrc', {
    // Rob, UTC-5, Day 60, one grace used
    emoji: '📚',
    color: rgb('33FF33'),
    progress: 0.5,
    path: [
  ...
  await Player.image('Liz', {
    ...
    color: rgb('00637b'), progress: 0.25,
    path: [
      'London',
      'Paris',
      'Nice',
